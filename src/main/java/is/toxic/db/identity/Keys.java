...
import is.toxic.db.identity.tables.records.AspNetRoleClaimsRecord;
import is.toxic.db.identity.tables.records.AspNetRolesRecord;
import is.toxic.db.identity.tables.records.AspNetUserClaimsRecord;
import is.toxic.db.identity.tables.records.AspNetUserLoginsRecord;
import is.toxic.db.identity.tables.records.AspNetUserRolesRecord;
import is.toxic.db.identity.tables.records.AspNetUserTokensRecord;
import is.toxic.db.identity.tables.records.AspNetUsersRecord;
import is.toxic.db.identity.tables.records.PersistedGrantsRecord;
import is.toxic.db.identity.tables.records.SignInsRecord;
import is.toxic.db.identity.tables.records.TelegramStatesRecord;
import is.toxic.db.identity.tables.records.__EfmigrationshistoryRecord;
