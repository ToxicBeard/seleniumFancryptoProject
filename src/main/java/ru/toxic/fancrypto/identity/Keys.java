...
import ru.toxic.fancrypto.identity.tables.records.AspNetUserRolesRecord;
import ru.toxic.fancrypto.identity.tables.records.AspNetUserTokensRecord;
import ru.toxic.fancrypto.identity.tables.records.AspNetUsersRecord;
import ru.toxic.fancrypto.identity.tables.records.PersistedGrantsRecord;
import ru.toxic.fancrypto.identity.tables.records.SignInsRecord;
import ru.toxic.fancrypto.identity.tables.records.TelegramStatesRecord;
import ru.toxic.fancrypto.identity.tables.records.__EfmigrationshistoryRecord;
